...
import com.beisun.vmscloud.dao.m630000.Mapper630000;
...
public class ServiceImpl630000 implements IBillCheckService {
    ...
    //本省机构号
    private @Getter @Setter String Pbranch_no = "630000";
     ...
     */
    @Override
    @Transactional(value = "tx630000", propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
