...
import com.beisun.vmscloud.dao.m360000.Mapper360000;
...
public class ServiceImpl360000 implements IBillCheckService {
    ...
    //本省机构号
    private @Getter @Setter String Pbranch_no = "360000";
     ...
     */
    @Override
    @Transactional(value = "tx360000", propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
