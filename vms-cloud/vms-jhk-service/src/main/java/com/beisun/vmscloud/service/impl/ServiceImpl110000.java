...
import com.beisun.vmscloud.dao.m110000.Mapper110000;
...
public class ServiceImpl110000 implements IBillCheckService {
    ...
    //本省机构号
    private @Getter @Setter String Pbranch_no = "110000";
     ...
     */
    @Override
    @Transactional(value = "tx110000", propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
