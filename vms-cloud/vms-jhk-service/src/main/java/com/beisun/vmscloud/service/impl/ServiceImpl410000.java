...
import com.beisun.vmscloud.dao.m410000.Mapper410000;
...
public class ServiceImpl410000 implements IBillCheckService {
    ...
    //本省机构号
    private @Getter @Setter String Pbranch_no = "410000";
     ...
     */
    @Override
    @Transactional(value = "tx410000", propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
