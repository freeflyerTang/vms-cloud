...
import com.beisun.vmscloud.dao.m350000.Mapper350000;
...
public class ServiceImpl350000 implements IBillCheckService {
    ...
    //本省机构号
    private @Getter @Setter String Pbranch_no = "350000";
     ...
     */
    @Override
    @Transactional(value = "tx350000", propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
