...
import com.beisun.vmscloud.dao.m230000.Mapper230000;
...
public class ServiceImpl230000 implements IBillCheckService {
    ...
    //本省机构号
    private @Getter @Setter String Pbranch_no = "230000";
     ...
     */
    @Override
    @Transactional(value = "tx230000", propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
