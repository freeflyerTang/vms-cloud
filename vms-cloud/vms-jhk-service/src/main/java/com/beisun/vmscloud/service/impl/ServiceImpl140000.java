...
import com.beisun.vmscloud.dao.m140000.Mapper140000;
...
public class ServiceImpl140000 implements IBillCheckService {
    ...
    //本省机构号
    private @Getter @Setter String Pbranch_no = "140000";
     ...
     */
    @Override
    @Transactional(value = "tx140000", propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
