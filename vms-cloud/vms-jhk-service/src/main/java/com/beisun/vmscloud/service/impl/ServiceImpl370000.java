...
import com.beisun.vmscloud.dao.m370000.Mapper370000;
...
public class ServiceImpl370000 implements IBillCheckService {
    ...
    //本省机构号
    private @Getter @Setter String Pbranch_no = "370000";
     ...
     */
    @Override
    @Transactional(value = "tx370000", propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
