...
import com.beisun.vmscloud.dao.m660000.Mapper660000;
...
public class ServiceImpl660000 implements IBillCheckService {
    ...
    //本省机构号
    private @Getter @Setter String Pbranch_no = "660000";
     ...
     */
    @Override
    @Transactional(value = "tx660000", propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
