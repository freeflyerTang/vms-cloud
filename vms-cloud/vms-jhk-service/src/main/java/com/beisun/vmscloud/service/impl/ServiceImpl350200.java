...
import com.beisun.vmscloud.dao.m350200.Mapper350200;
...
public class ServiceImpl350200 implements IBillCheckService {
    ...
    //本省机构号
    private @Getter @Setter String Pbranch_no = "350200";
     ...
     */
    @Override
    @Transactional(value = "tx350200", propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
