...
import com.beisun.vmscloud.dao.m210000.Mapper210000;
...
public class ServiceImpl210000 implements IBillCheckService {
    ...
    //本省机构号
    private @Getter @Setter String Pbranch_no = "210000";
     ...
     */
    @Override
    @Transactional(value = "tx210000", propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
