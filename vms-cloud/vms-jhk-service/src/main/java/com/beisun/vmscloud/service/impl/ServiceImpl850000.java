...
import com.beisun.vmscloud.dao.m120000.Mapper120000;
...
public class ServiceImpl850000 implements IBillCheckService {
    ...
    //本省机构号
    private @Getter @Setter String Pbranch_no = "850000";
     ...
     */
    @Override
    @Transactional(value = "tx850000", propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
