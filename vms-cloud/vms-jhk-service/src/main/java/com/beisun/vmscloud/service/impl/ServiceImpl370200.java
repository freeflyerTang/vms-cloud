...
import com.beisun.vmscloud.dao.m370200.Mapper370200;
...
public class ServiceImpl370200 implements IBillCheckService {
    ...
    //本省机构号
    private @Getter @Setter String Pbranch_no = "370200";
     ...
     */
    @Override
    @Transactional(value = "tx370200", propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
