...
import com.beisun.vmscloud.dao.m150000.Mapper150000;
...
public class ServiceImpl150000 implements IBillCheckService {
    ...
    //本省机构号
    private @Getter @Setter String Pbranch_no = "150000";
     ...
     */
    @Override
    @Transactional(value = "tx150000", propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
