...
import com.beisun.vmscloud.dao.m460000.Mapper460000;
...
public class ServiceImpl460000 implements IBillCheckService {
    ...
    //本省机构号
    private @Getter @Setter String Pbranch_no = "460000";
     ...
     */
    @Override
    @Transactional(value = "tx460000", propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
