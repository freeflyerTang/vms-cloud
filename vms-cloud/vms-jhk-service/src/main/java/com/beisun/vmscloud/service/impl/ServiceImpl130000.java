...
import com.beisun.vmscloud.dao.m130000.Mapper130000;
...
public class ServiceImpl130000 implements IBillCheckService {
    ...
    //本省机构号
    private @Getter @Setter String Pbranch_no = "130000";
     ...
     */
    @Override
    @Transactional(value = "tx130000", propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
