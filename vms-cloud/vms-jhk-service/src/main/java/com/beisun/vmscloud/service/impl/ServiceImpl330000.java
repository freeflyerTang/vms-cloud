...
import com.beisun.vmscloud.dao.m330000.Mapper330000;
...
public class ServiceImpl330000 implements IBillCheckService {
    ...
    //本省机构号
    private @Getter @Setter String Pbranch_no = "330000";
     ...
     */
    @Override
    @Transactional(value = "tx330000", propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
