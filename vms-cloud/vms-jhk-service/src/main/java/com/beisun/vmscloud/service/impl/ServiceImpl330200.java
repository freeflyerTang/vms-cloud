...
import com.beisun.vmscloud.dao.m330200.Mapper330200;
...
public class ServiceImpl330200 implements IBillCheckService {
    ...
    //本省机构号
    private @Getter @Setter String Pbranch_no = "330200";
     ...
     */
    @Override
    @Transactional(value = "tx330200", propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
