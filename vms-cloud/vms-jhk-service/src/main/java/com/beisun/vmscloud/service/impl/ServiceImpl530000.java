...
import com.beisun.vmscloud.dao.m530000.Mapper530000;
...
public class ServiceImpl530000 implements IBillCheckService {
    ...
    //本省机构号
    private @Getter @Setter String Pbranch_no = "530000";
     ...
     */
    @Override
    @Transactional(value = "tx530000", propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
