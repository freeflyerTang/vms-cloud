...
import com.beisun.vmscloud.dao.m310000.Mapper310000;
...
public class ServiceImpl310000 implements IBillCheckService {
    ...
    //本省机构号
    private @Getter @Setter String Pbranch_no = "310000";
     ...
     */
    @Override
    @Transactional(value = "tx310000", propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
