...
import com.beisun.vmscloud.dao.m440200.Mapper440200;
...
public class ServiceImpl440200 implements IBillCheckService {
    ...
    //本省机构号
    private @Getter @Setter String Pbranch_no = "440200";
     ...
     */
    @Override
    @Transactional(value = "tx440200", propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
