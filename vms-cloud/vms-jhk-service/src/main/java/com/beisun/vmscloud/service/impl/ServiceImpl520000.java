...
import com.beisun.vmscloud.dao.m520000.Mapper520000;
...
public class ServiceImpl520000 implements IBillCheckService {
    ...
    //本省机构号
    private @Getter @Setter String Pbranch_no = "520000";
     ...
     */
    @Override
    @Transactional(value = "tx520000", propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
