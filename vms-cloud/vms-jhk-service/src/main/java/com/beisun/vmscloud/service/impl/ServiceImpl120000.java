...
public class ServiceImpl120000 implements IBillCheckService {
    ...
    //本省机构号
    private @Getter @Setter String Pbranch_no = "120000";
     ...
     */
    @Override
    @Transactional(value = "tx120000", propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
