...
import com.beisun.vmscloud.dao.m650000.Mapper650000;
...
public class ServiceImpl650000 implements IBillCheckService {
    ...
    //本省机构号
    private @Getter @Setter String Pbranch_no = "650000";
     ...
     */
    @Override
    @Transactional(value = "tx650000", propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
