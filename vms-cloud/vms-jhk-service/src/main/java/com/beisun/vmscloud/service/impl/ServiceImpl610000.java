...
import com.beisun.vmscloud.dao.m610000.Mapper610000;
...
public class ServiceImpl610000 implements IBillCheckService {
    ...
    //本省机构号
    private @Getter @Setter String Pbranch_no = "610000";
     ...
     */
    @Override
    @Transactional(value = "tx610000", propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
