...
import com.beisun.vmscloud.dao.m430000.Mapper430000;
...
public class ServiceImpl430000 implements IBillCheckService {
    ...
    //本省机构号
    private @Getter @Setter String Pbranch_no = "430000";
     ...
     */
    @Override
    @Transactional(value = "tx430000", propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
