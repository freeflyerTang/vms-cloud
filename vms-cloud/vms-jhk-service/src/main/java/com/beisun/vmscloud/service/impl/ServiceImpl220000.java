...
import com.beisun.vmscloud.dao.m220000.Mapper220000;
...
public class ServiceImpl220000 implements IBillCheckService {
    ...
    //本省机构号
    private @Getter @Setter String Pbranch_no = "220000";
     ...
     */
    @Override
    @Transactional(value = "tx220000", propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
