...
import com.beisun.vmscloud.dao.m440000.Mapper440000;
...
public class ServiceImpl440000 implements IBillCheckService {
    ...
    //本省机构号
    private @Getter @Setter String Pbranch_no = "440000";
     ...
     */
    @Override
    @Transactional(value = "tx440000", propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
