...
import com.beisun.vmscloud.dao.m320000.Mapper320000;
...
public class ServiceImpl320000 implements IBillCheckService {
    ...
    //本省机构号
    private @Getter @Setter String Pbranch_no = "320000";
     ...
     */
    @Override
    @Transactional(value = "tx320000", propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
