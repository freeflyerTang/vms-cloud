...
import com.beisun.vmscloud.dao.m340000.Mapper340000;
...
public class ServiceImpl340000 implements IBillCheckService {
    ...
    //本省机构号
    private @Getter @Setter String Pbranch_no = "340000";
     ...
     */
    @Override
    @Transactional(value = "tx340000", propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
