...
import com.beisun.vmscloud.dao.m420000.Mapper420000;
...
public class ServiceImpl420000 implements IBillCheckService {
    ...
    //本省机构号
    private @Getter @Setter String Pbranch_no = "420000";
     ...
     */
    @Override
    @Transactional(value = "tx420000", propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
